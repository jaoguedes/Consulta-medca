    ...
    public class MedicosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Medicos != null ? 
                          ...
                          Problem("Entity set 'Context.Medicos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicoId,Nome")] Medico medico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("MedicoId,Nome")] Medico medico)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'Context.Medicos'  is null.");
            }
            var medico = await _context.Medicos.FindAsync(id);
            if (medico != null)
            {
